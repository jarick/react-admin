...
export default {
  ...
  "array": {
    ...
    "includesSingle": "единственное значение \"{{!key}}\" не соответствует ни одному из допустимых типов",
    "includesOne": "в позиции {{pos}} не проходит проверку, потому что {{reason}}",
    "includesOneSingle": "единственное значение \"{{!key}}\" не проходит проверку, потому что {{reason}}",
    ...
    "excludesSingle": "единственное значение \"{{!key}}\" содержит исключенное значение",
  ...
  "object": {
    ...
    "child": "дочерний элемент \"{{!key}}\" не проходит проверку, потому что {{reason}}",
